...
@CronappSecurity
public class ConvertProductExitsOnSheet {
    ...
    try {
        ...
        cronapi.io.Operations.readLine(file2, (sender_line) -> {
            ...
            Var.valueOf(1).equals(count)).getObjectAsBoolean()).getObjectAsBoolean()) {
                ...
                .negate().getObjectAsBoolean()) {
                    productExit =
                    cronapi.database.Operations.newEntity(Var.valueOf("app.entity.ProductExit"),Var.valueOf("id",
                    ...
                    cronapi.list.Operations.get(listGeneratedByLines,
                    Var.valueOf(5))));
                    cronapi.list.Operations.set(productExitsList,(listIndex),productExit);
                }
                listIndex =
        ...
        Var.valueOf("Erro ao converter saídas da planilha.")));
     }
